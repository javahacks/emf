/**
 */
package com.javahacks.emf.mt.model.provider;
...
/**
 * This is the item provider adapter for a {@link com.javahacks.emf.mt.model.Signal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignalItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.SIGNAL__NAME,
				 true,
				 false,
				 false,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signal_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_value_feature", "_UI_Signal_type"),
				 ModelPackage.Literals.SIGNAL__VALUE,
				 true,
				 false,
				 false,
	...
	protected void addUpdatesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signal_updates_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_updates_feature", "_UI_Signal_type"),
				 ModelPackage.Literals.SIGNAL__UPDATES,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Signal.class)) {
			case ModelPackage.SIGNAL__NAME:
			case ModelPackage.SIGNAL__VALUE:
			case ModelPackage.SIGNAL__UPDATES:
